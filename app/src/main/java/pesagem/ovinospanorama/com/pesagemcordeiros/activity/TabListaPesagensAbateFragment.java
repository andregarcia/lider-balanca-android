...
public class TabListaPesagensAbateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pesagens = Pesagens.getPesagens(Pesagens.PesagensType.PESAGEM_ABATE);
        listaPesagensListViewArrayAdapter = new PesagemListAdapter(view.getContext(), pesagens);
